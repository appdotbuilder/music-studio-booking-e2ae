 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Booking> $verifiedBookings
 * @property-read int|null $verified_bookings_count
...
class User extends Authenticatable
{
    ...
    /**
     * Get the bookings verified by this user (admin).
     */
